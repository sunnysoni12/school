...
<tr class="odd">
    ...
    <td><a href="{{url('/editCategory/'.$data->id)}}"><i class="fa fa-edit"></i></a>
        <a href="{{url('/deleteCategory/'.$data->id)}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i></i></a>
    </td>
