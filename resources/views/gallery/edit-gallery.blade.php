...
<input autofocus="" id="class" name="class" placeholder="" type="text" class="form-control" value="@if(!empty($result1[0]['gallery']->class)){{$result1[0]['gallery']->class}}@endif" autocomplete="off">
<span class="text-danger"></span>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Section</label><small class="req"> *</small>
<input id="section" name="section" placeholder="" type="text" class="form-control" value="@if(!empty($result1[0]['gallery']->section)){{$result1[0]['gallery']->section}}@endif">
<span class="text-danger"></span>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Session</label><small class="req"> *</small>
<input id="session" name="session" placeholder="" type="text" class="form-control" value="@if(!empty($result1[0]['gallery']->session)){{$result1[0]['gallery']->session}}@endif">
<span class="text-danger"></span>
</div>
<div class="form-group">
<label for="exampleInputEmail1">Date</label><small class="req"> *</small>
<input id="date" name="date" placeholder="" type="date" class="form-control" value="">@if(!empty($result1[0]['gallery']->date)){{$result1[0]['gallery']->date}}@endif
<span class="text-danger"></span>
</div>
<div class="form-group">
...
<input type="hidden" name="file" value="@if(!empty($result1[0]['gallery']->photos)){{$result1[0]['gallery']->photos}}@endif">
<div class="form-group">
